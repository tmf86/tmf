...
class FormationController extends Controller
{
    public function index()
    {
        ...
        $links = [sprintf('<link rel="stylesheet" href="%s" type="text/css" media="screen"/>', buildpath('public/css/import/venobox.min.css'))];
        $scripts = [
            sprintf('<script type="text/javascript" src="%s"></script>', buildpath('public/js/import/venobox.min.js')),
            "<script>
                $(function(){ 
                    $('.venobox').venobox(
                        {
