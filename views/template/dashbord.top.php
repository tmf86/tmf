...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?= buildpath('public/css/import/chartist/dist/chartist.min.css') ?>" rel="stylesheet">
    <!-- Custom CSS -->
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#"
                           id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="<?= buildpath($user->image) ?>" alt="user" class="rounded-circle" width="31">
                        </a>
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                            ...
                            <div class="user-content hide-menu m-l-10">
                                <a href="#" class="" id="Userdd" role="button"
                                   data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <h5 class="m-b-0 user-name font-medium"><?= $user->nom . ' ' . $user->prenom ?> <i
                    ...
                    <li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark sidebar-link"
                                                href="<?= buildpath('profile') ?>" aria-expanded="false"><i
