                                        ...
                                        <p style="font-size: 14px; line-height: 140%;"><span
                                                    style="font-family: Cabin, sans-serif; font-size: 14px; line-height: 19.6px;"><span
                                                        style="font-size: 26px; line-height: 36.4px;"><strong><span
                                                                style="line-height: 36.4px; font-size: 26px; text-decoration: underline;">VOS IDENTIFIANTS DE PARRAINAGE</span></strong></span></span>
                                        </p>
                                    </div>
                                </td>
                            </tr>
                                    ...
                                    <div style="color: #000000; line-height: 170%; text-align: justify; word-wrap: break-word;">
                                        <p style="font-size: 14px; line-height: 170%;">
                                            ...
                                            <span
                                                ...
                                                Veuillez s'il vous plait garder ces informations en lieux sur pour eviter toutes eventualités de
                                                problèmes d'accès a votre espace parrainage.
                                            </span>
                                        </p>
                                    </div>
                                </td>
