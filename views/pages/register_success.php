...
<div class="main-success">
    <div class="success-container">
        <img src="<?= sprintf("%simages/success.png", rootUrl()) ?>" class="success-img" alt="succes-icon">
    </div>
    <div class="success-msg">
        Felicitation !<br>
        Un mail vient de voir être envoyé pour finaliser la creation de votre compte d'utilisateur.<br>
