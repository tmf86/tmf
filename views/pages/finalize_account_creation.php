<div class="form-container p-5 mb-5">
    <form class="text-center p-5 form-box" action="" method="post">
        ...
        <div>
            <!--            <div class="position-relative">-->
            <!--                <span class="password-eye"><i class="fas fa-eye"></i></i></span>-->
            <!--                <input type="text" name="username" value="fake_username" autocomplete="new-username" class="d-none">-->
            <!--            </div>-->
            <div class="position-relative">
                <span class="password-eye first eye-hide"><i class="fas fa-eye"></i></span>
            ...
            <div class="position-relative">
                <span class="password-eye second eye-hide"><i class="fas fa-eye"></i></span>
