        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item <?=$css_class?>">
                ...
                <div class="carousel-caption">
                    ...
                    <p style="overflow: auto;display: none;" class="annonce_content"><?= $Annonce->content_ann;?></p>
                    <p><button class="btn btn-warning annonce_click" >EN SAVOIR PLUS</button></p>
                </div>
            </div>
            <?php } ?>
            ...
            <div class="col-md">
                <div id="dialog" style="display: none;">
                    <div class="dialog_content">
                        ...
                        <p><button class="btn btn-primary">S'Inscrire</button></p>
                    </div>
                </div>
